  ...
  return (
    <main>
          ...
          <div className="swiper devServiceSlider">
            <div className="swiper-wrapper pb-10 lg:pb-16">
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  <div className="w-[70px] h-[70px] rounded-full bg-new-500 group-hover:bg-opacity-10 bg-opacity-10 pl-5 pt-3 mb-6">
                    <svg
                  ...
                  <p className="pb-6 text-white text-base">
                    Bridging the gap between blockchain and tangible assets. I
              ...
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  ...
                  <p className="pb-6 text-white text-base">
                    Benefit from seasoned blockchain guidance. With years of
              ...
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  ...
                  <p className="pb-6 text-white text-base">
                    Harness the power of the Ethereum Virtual Machine. With deep
              ...
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  ...
                  <p className="pb-6 text-white text-base">
                    Delve into the intricacies of Assembly, Huff, and Yul. I
              ...
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  ...
                  <p className="pb-6 text-white text-base">
                    Redefine finance with decentralized solutions. I build DeFi
              ...
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  ...
                  <p className="pb-6 text-white text-base">
                    Seamless integration with blockchain networks. Expertise in
              ...
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  ...
                  <p className="pb-6 text-white text-base">
                    Simplifying user experiences with Account Abstraction. I
              ...
              <article className="swiper-slide">
                <div className="relative transition duration-200 cursor-pointer border border-transparent hover:border-new-500 bg-interface-600 px-7 py-8 group shadow-customThree rounded-custom">
                  ...
                  <p className="pb-6 text-white text-base">
                    Peace of mind with top-tier security audits. I meticulously
      ...
      <section className="pb-120">
        <div className="mx-auto px-4 sm:px-6 lg:max-w-7xl lg:px-8">
          <div className="bg-interface-600 rounded-xl border border-[#494C5F] p-8 xl:p-14">
