         ...
         <nav className="nav nav-dev">
           ...
           <div className="nav__menu" id="nav-menu">
             <ul className="nav__list">
               ...
               <li className="dropdown__item">
                 <div className="nav__link dropdown__button">
                   Pages<i className="fa-solid fa-angle-down dropdown__arrow"></i>
                 </div>
                 <div className="dropdown__container">
                   <ul className="dropdown__list">
                     <li>
                       <a href="team.html" className="dropdown__link">Team</a>
                     </li>
                     <li>
                       <a href="team-details.html" className="dropdown__link">Team Details</a>
                     </li>
                     <li>
                       <a href="achievement.html" className="dropdown__link">Achivement</a>
                     </li>
                     <li>
                       <a href="gallery.html" className="dropdown__link">Gallery</a>
                     </li>
                     <li>
                       <a href="products.html" className="dropdown__link">Products</a>
                     </li>
                     <li>
                       <a href="product-details-2.html" className="dropdown__link">Products Details</a>
                     </li>
                     <li>
                       <a href="contact-us.html" className="dropdown__link">Contact</a>
                     </li>
                   </ul>
                 </div>
               </li>
               <li className="dropdown__item">
                 <div className="nav__link dropdown__button">
                   About<i className="fa-solid fa-angle-down dropdown__arrow"></i>
                 </div>
                 <div className="dropdown__container">
                   <ul className="dropdown__list">
                     <li>
                       <a href="about-designer.html" className="dropdown__link">About One</a>
                     </li>
                     <li>
                       <a href="about-product-designer.html" className="dropdown__link">About Two</a>
                     </li>
                   </ul>
                 </div>
               </li>
